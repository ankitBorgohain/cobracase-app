...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper
          className="pt-10 pb-20 lg:grid lg:grid-cols-3 sm:pb-32 
        ...
        >
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                <span className="font-semibold text-green-800 bg-white px-1">
                  one-of-one
                </span>{" "}
              ...
              <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                <div className="space-y-2">
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h5 w-5 shrink-0 text-green-600" />
                    High-quality, durable material
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h5 w-5 shrink-0 text-green-600" />5 year
                    print garuntee
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h5 w-5 shrink-0 text-green-600 " />
            ...
            sm:items-start gap-5"
              >
                <div className="flex -space-x-4">
                  <img
                    className="inline-block h-10 w-10 ring-2 ring-gray-100 rounded-full"
                  ...
                  />
                  <img
                    className="inline-block object-cover h-10 w-10 ring-2 ring-gray-100 rounded-full"
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl border border-black-100">
              <img
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-col-1 px-4 lg:max-0 lg:max-w-none lg:grid-col-2 gap-y-16 ">
